...
Seems like link above doesn't work any more. Here is another one https://jelastic.zendesk.com/entries/22102272-How-to-design-a-multi-tenant-mysql-database-MySQL-example-, not as good as the one above but it's the best that I could find in the network.
...
* {<img src="https://travis-ci.org/activebridge/multitenant-mysql.png?branch=master"/>}[http://travis-ci.org/activebridge/multitenant-mysql]
* {<img src="https://gemnasium.com/activebridge/multitenant-mysql.png" alt="Dependency Status" />}[https://gemnasium.com/activebridge/multitenant-mysql]
* {<img src="https://codeclimate.com/github/activebridge/multitenant-mysql.png" />}[https://codeclimate.com/github/activebridge/multitenant-mysql]
* {<img src="https://coveralls.io/repos/activebridge/multitenant-mysql/badge.png?branch=master" alt="Coverage Status" />}[https://coveralls.io/r/eugenekorpan/multitenant-mysql?branch=master]
